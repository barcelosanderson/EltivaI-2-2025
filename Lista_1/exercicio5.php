...
<body>
    ...
    <div class="p-5 d-flex flex-column align-items-center vh-100">
        <div class="caixa">
            <h1 style="color:white">Exercício 5 - Média de Valores</h1>
            <form method="post">
                <div class="mb-3">
                    <label for="valor1" class="form-label" style="color:white">Informe a primeira nota</label>
                    <input type="number" id="valor1" name="valor1" class="form-control" required="">
                </div>
                <div class="mb-3">
                    <label for="valor2" class="form-label" style="color:white">Informe a segunda nota</label>
                    <input type="number" id="valor2" name="valor2" class="form-control" required="">
                </div>
                <div class="mb-3">
                    <label for="valor3" class="form-label" style="color:white">Informe a terceira nota</label>
