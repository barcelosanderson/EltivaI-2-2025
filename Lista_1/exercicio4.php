...
<head>
    ...
    <title>Dividindo com o Anderson</title>
...
<body>
    ...
    <div class="p-5 d-flex flex-column align-items-center vh-100">
        <div class="caixa">
            <h1 style="color:white">Exercício 4 - Divisão de Valores</h1>
            <form method="post">
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" id="valor2" name="valor2" class="form-control" min="1" required="">
                </div>
