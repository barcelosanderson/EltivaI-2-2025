...
<body>
    ...
    <div class="p-5 d-flex flex-column align-items-center vh-100">
        <div class="caixa">
            <h1 style="color: white">Exercício 9 - Cálculo de área do círculo</h1>
            <form method="post">
                <div class="mb-3">
            ...
            <div class="mt-5 d-flex flex-column align-items-center gap-2" style="color:white">
                ...
                if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                    $valor1 = $_POST["valor1"];
                    $areacirc = $valor1 ** 2 * pi();
                    $areacirc_formatado = number_format($areacirc, 2, ',', '.');
                    echo "<h1 style=color:white>Área: $areacirc_formatado </h1>";
