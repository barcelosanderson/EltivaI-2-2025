...
<body>
    ...
    <div class="p-5 d-flex flex-column align-items-center vh-100">
        <div class="caixa">
            <h1 style="color: white">Exercício 11 - Cálculo do perímetro do círculo</h1>
            <form method="post">
                <div class="mb-3">
                    <label for="valor1" class="form-label" style="color:white ">Insira o raio: </label>
            ...
            <div class="mt-5 d-flex flex-column align-items-center gap-2" style="color:white">
                ...
                if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                    $valor1 = $_POST["valor1"];
                    $pericirc = 2 * $valor1 * pi();
                    $pericirc_formatado = number_format($pericirc, 2, ',', '.');
                    echo "<h1 style=color:white>Perímetro: $pericirc_formatado </h1>";
