...
<body>
    ...
    <div class="p-5 d-flex flex-column align-items-center vh-100">
        <div class="caixa">
            <h1 style="color: white">Exercício 13 - Conversão metros para centímetros</h1>
            <form method="post">
                <div class="mb-3">
                    <label for="valor1" class="form-label" style="color:white ">Insira o valor em metros: </label>
            ...
            <div class="mt-5 d-flex flex-column align-items-center gap-2" style="color:white">
                ...
                if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                    $valor1 = $_POST["valor1"];
                    $convertperim = $valor1 * 100;
                    echo "<h1 style=color:white>Conversão: $convertperim cm </h1>";
